...
> [ACKNOWLEDGEMENTS.md](ACKNOWLEDGEMENTS.md). The dependency/security upgrade
> work was performed primarily with assistance from Codex/AI, with human review
> and verification by Bytecat. Bytecat: https://bytecat.ai.
...
The detailed upgrade notes and verification list are in
[.bytecat/UPGRADE_ISSUES.md](.bytecat/UPGRADE_ISSUES.md).
