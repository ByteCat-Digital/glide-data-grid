...
const GridScroller: React.FunctionComponent<ScrollingDataGridProps> = p => {
    ...
    const last = React.useRef<Rectangle | undefined | undefined>(undefined);
    const lastX = React.useRef<number | undefined | undefined>(undefined);
    const lastY = React.useRef<number | undefined | undefined>(undefined);
    const lastSize = React.useRef<readonly [number, number] | undefined | undefined>(undefined);
