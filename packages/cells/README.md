...
> **Bytecat fork notice**
>
> This package is the `@bytecat/glide-data-grid-cells` fork of upstream
> `@glideapps/glide-data-grid-cells`. It exists as part of the Bytecat fork to
...
```shell
npm i @bytecat/glide-data-grid-cells
```

```tsx
import { allCells } from "@bytecat/glide-data-grid-cells";
```
